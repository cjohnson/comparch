  ...
  if (opcode == 0b0110111) {
    ...
    switch (funct3) {
      ...
      case 0b001:
        ...
        break;
      case 0b100:
        next_idex.opcode = Opcode::BLT;
        break;
      case 0b101:
        next_idex.opcode = Opcode::BGE;
        break;
      case 0b110:
    ...
    next_idex.imm = 0;
    next_idex.imm |= (((ifid.inst >> 8) & 0b1111) << 1);
    next_idex.imm |= (((ifid.inst >> 25) & 0b111111) << 5);
    next_idex.imm |= (((ifid.inst >> 7) & 0b1) << 11);
    next_idex.imm |= (((ifid.inst >> 31) & 0b1) << 12);
    ...
    switch (funct3) {
      case 0b000: {
        int add_sub_flag = (ifid.inst >> 30) & 0x1;
        next_idex.opcode = add_sub_flag ? Opcode::SUB : Opcode::ADD;
        break;
      }
      case 0b001:
      ...
      case 0b100:
        ...
        break;
      case 0b101: {
        int arithmetic_flag = (ifid.inst >> 30) & 0x1;
...
void rv32i_io::Core::ProcessWriteback(
  ...
  if (memwb.valid && !memwb.illegal && memwb.rd != 0) next_user_registers[memwb.rd] = memwb.v;
}
